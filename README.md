...
- For the complete 2026-07-15 through 2026-07-22 `深耕信義／信義深耕` LINE record and the current Xinyi application-pause status, retained group/support path, deferred B/B2 assets, and 8/7 confirmation gate: `records/2026-07-22/README.md`

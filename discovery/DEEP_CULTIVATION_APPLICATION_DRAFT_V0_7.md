...
```text
本 v0.7 保留為歷史討論稿。CRM 已依 2026-06-19 owner update 完全排除於 Jason / 陽明交大目前 package 之外。後續請使用 AI-only v0.8 planning：泌尿科門診前問診與醫師覆核摘要支持系統，三年 NT$10,000,000 作為 AI 問診與摘要 package 討論額度。
```
...
v0.7 將 v0.6 的三年期、總經費新臺幣 1,000 萬元、KPI-to-budget、20 頁討論稿控制，更新為更接近直接交付的正式提案篇排工作稿。

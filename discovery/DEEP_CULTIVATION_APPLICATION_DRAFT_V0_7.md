...
```text
本 v0.7 保留為歷史討論稿。CRM 已依 2026-06-19 owner update 完全排除於 Jason / 陽明交大目前 package 之外。後續請使用 AI-only v0.8 planning：泌尿科門診前問診與醫師覆核摘要支持系統，每年 NT$10,000,000，三年合計 NT$30,000,000 作為 AI 問診與摘要 package 討論額度。
```
...
本輪討論取代文件：`DEEP_CULTIVATION_APPLICATION_DRAFT_V0_6.md`
...
v0.7 將 v0.6 的每年經費新臺幣 1,000 萬元、三年合計新臺幣 3,000 萬元、KPI-to-budget、20 頁討論稿控制，更新為更接近直接交付的正式提案篇排工作稿。
...
本版使用正式提案篇排作為填報骨架，臨床內容仍以泌尿科門診前問診與醫師覆核摘要支持系統的 evidence 為主。
...
| 三年期執行矩陣 | 第 1 年建置與 reviewer evidence、第 2 年核准後 workflow evaluation、第 3 年完成三年成果彙整、維運移轉與下一階段擴充準備 |
...
| 工作包 | 目的 | 主要 KPI | 證據文件 |
| --- | --- | --- | --- |
| WP1 填報與 workflow governance | 將 v0.7 轉入 parent proposal format，確認子計畫身份與 owner | 20 頁討論稿完成；official blanks visible | proposal checklist、owner table |
...
| Proposal coordinator | changelog、review response、attachment pack、page control | 待確認 | v0.7 討論版目前需要此角色 |
...
| --- | --- | --- | --- |
| 2026-06-02 discussion | 對齊 category、篇排、scope、budget、owner、governance | v0.7 draft、KPI-budget table、reference analysis | Prof. Wu / parent owner discussion |
...
| Year 3 成果彙整與維運移轉 | 完成三年 KPI evidence、維運責任、訓練紀錄、CRM-ready field package 與下一階段 governance brief | final KPI report、maintenance owner、training record、next-stage governance brief | scale-up follows evidence、owner and governance |
...
| 為什麼採用正式提案篇排？ | 此篇排能讓封面、服務系統、三年矩陣、組織、治理、KPI 與預算在同一份討論稿中被 parent owner 快速檢查。 |
...
- [ ] 確認 v0.7 是 standalone subproject、work package 或 appendix。
- [ ] 確認 parent applicant、official mode、proposal period、partner list。
- [ ] 確認 category design：主打範疇三，副支援範疇一。
- [ ] 確認 parent proposal 是否接受本版正式提案篇排作為 section model。

...
Use this rubric with the writing-quality controls:
...
| Assertive narrative gate | Contribution-first opening, workflow value, deliberate scope, governance boundary, and evidence gate. | A1, A2, A4, C4, D5 | A capped at 79 and D capped at 89 if the draft opens with defensive limitations or hides value behind apology language. |
...
| A | Main narrative is defensive and fails to state workflow value before limitations. | 79 |
...
| D | Proposal narrative has correct format but opens with self-weakening limitation language. | 89 |
...
| Clinical friction reduction | Net reduction in physician/nurse/staff burden, clicks, duplicate entry, repeated questioning, and cognitive load. | AI system adds labeling, dashboards, extra review, or hidden nurse work without removing larger existing burden. |
| Assertive writing | Contribution-first proposal narrative that frames boundaries as governed design choices. | Defensive limitation-first language that makes a serious workflow-support system sound like an apologetic demo. |
...
| Outward-facing draft fails assertive writing gate | -5 to -10 |
...
| Defensive narrative obscures contribution or workflow value | A -5, D -5 |

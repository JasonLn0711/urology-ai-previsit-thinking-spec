...
subtitle: "參照子計畫三篇排風格之 working discussion proposal"
author: "工作草稿"
date: "2026-05-31"
lang: zh-TW
---
...
### 參照子計畫三篇排風格之 working discussion proposal
...
| --- | --- | --- | --- | --- |
| 115 prep / 2026-06-02 discussion | 完成 working discussion proposal | v0.6 草稿、子計畫三篇排風格 docx、KPI-budget table、governance owner questions | parent owner discussion | working discussion proposal |
...
| 118 phase 5-6 | 延伸 / 維持 / 停止決策 | final KPI report、maintenance plan、integration or CRM decision | scale-up follows evidence and owner | governed production planning |
...
5. HIS / EMR / EHR writeback 進入後續系統串接與治理確認。
6. Production clinical-use approval 由院內治理程序確認。
7. Citywide scale-up 由 site ownership、maintenance plan 與 evidence package 支撐。
8. CRM-ready design 先建立欄位、責任與治理條件，後續再決定 production deployment。
...
# 十三、經費編列明細總表：每年新臺幣 1,000 萬元、三年合計新臺幣 3,000 萬元 discussion allocation
...
本文件是參照子計畫三篇排風格之 working discussion proposal。正式送件前需轉入最新官方 Word template，並由 parent proposal owner 確認申請路徑、院內行政欄位、正式會計科目、治理 self-check、附件與簽核程序。
